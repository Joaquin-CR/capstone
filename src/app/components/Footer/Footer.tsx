...
export default function Footer() {
  const content = (
    <>
      <div className="flex flex-col bg-black text-white w-full h-56 justify-between">
        <div className="flex justify-between mr-20 mt-8">
          <div className="flex ml-4">
            <Image className="h-14 w-20" src={LogoPocket} alt={'Logo'} />
            <div className="ml-7 font-AlataR">
              <p>The Pocket</p>
        ...
        <div className="flex justify-between mx-6 mb-5">
          ...
          <div className="text-lg font-AlataR">The Pocket</div>
        </div>
      </div>
    </>
  );
